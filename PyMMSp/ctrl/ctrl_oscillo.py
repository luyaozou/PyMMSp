...
class CtrlOscillo(QtWidgets.QWidget):
    ...
    def __init__(self, prefs, ui, info, handle, parent=None):
        ...
        self.ui.scopeStatus.clicked.connect(self.check)
        self.ui.scopeStatus.refreshButton.clicked.connect(self.manual_refresh)
    ...
    def tune_sensitivity(self, sens_idx):
        ...
        self.ui.oscilloPanel.sensSel.setStyleSheet(f'border: 1px solid {ui_shared.msg_color(status)}')
